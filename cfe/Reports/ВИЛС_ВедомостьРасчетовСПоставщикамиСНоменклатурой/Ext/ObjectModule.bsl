...
// end fix Suetin 30.04.2021 13:48:07
	...
	|	СУММА(Расчеты.ОплаченоВсего)                            КАК ОплаченоВсего,
	|	СУММА(Расчеты.СписаниеПереоценкаВсего)                  КАК СписаниеПереоценкаВсего,
	|   МАКСИМУМ(Расчеты.ДатаПоступления)                       КАК ДатаПоступления
	|		
	|ИЗ (
	|	ВЫБРАТЬ
	|		РасчетыПредварительная.Организация КАК Организация,
	...
	|	ВЫБРАТЬ
	|		ВЫБОР
	|			КОГДА ЗаказыПоставщикам.ЗаказПоставщику.Ссылка ССЫЛКА Документ.ЗаказДавальца
	|				ТОГДА ДокЗаказДавальца.Организация
	|			КОГДА ЗаказыПоставщикам.ЗаказПоставщику.Ссылка ССЫЛКА Документ.ЗаказПоставщику
	|				ТОГДА ДокЗаказПоставщику.Организация
	|			КОГДА ЗаказыПоставщикам.ЗаказПоставщику.Ссылка ССЫЛКА Документ.ЗаказПереработчику
	|				ТОГДА ДокЗаказПереработчику.Организация
	|			КОГДА ЗаказыПоставщикам.ЗаказПоставщику.Ссылка ССЫЛКА Документ.ЗаказНаПроизводство
	|				ТОГДА ДокЗаказНаПроизводство.Организация
	|			ИНАЧЕ NULL
	|		КОНЕЦ КАК Организация,
	|		ВЫБОР
	|			КОГДА ЗаказыПоставщикам.ЗаказПоставщику.Ссылка ССЫЛКА Документ.ЗаказДавальца
	|				ТОГДА ДокЗаказДавальца.Партнер
	|			КОГДА ЗаказыПоставщикам.ЗаказПоставщику.Ссылка ССЫЛКА Документ.ЗаказПоставщику
	|				ТОГДА ДокЗаказПоставщику.Партнер
	|			КОГДА ЗаказыПоставщикам.ЗаказПоставщику.Ссылка ССЫЛКА Документ.ЗаказПереработчику
	|				ТОГДА ДокЗаказПереработчику.Партнер
	|			КОГДА ЗаказыПоставщикам.ЗаказПоставщику.Ссылка ССЫЛКА Документ.ЗаказНаПроизводство
	|				ТОГДА NULL		// fix Suetin 12.05.2021 15:01:17	ДокЗаказНаПроизводство.Партнер
	|			ИНАЧЕ NULL
	|		КОНЕЦ КАК Партнер,
	|		ВЫБОР
	|			КОГДА ЗаказыПоставщикам.ЗаказПоставщику.Ссылка ССЫЛКА Документ.ЗаказДавальца
	|				ТОГДА ДокЗаказДавальца.Контрагент
	|			КОГДА ЗаказыПоставщикам.ЗаказПоставщику.Ссылка ССЫЛКА Документ.ЗаказПоставщику
	|				ТОГДА ДокЗаказПоставщику.Контрагент
	|			КОГДА ЗаказыПоставщикам.ЗаказПоставщику.Ссылка ССЫЛКА Документ.ЗаказПереработчику
	|				ТОГДА ДокЗаказПереработчику.Контрагент
	|			КОГДА ЗаказыПоставщикам.ЗаказПоставщику.Ссылка ССЫЛКА Документ.ЗаказНаПроизводство
	|				ТОГДА NULL		// fix Suetin 12.05.2021 15:01:17	ДокЗаказНаПроизводство.Контрагент
	|			ИНАЧЕ NULL
	|		КОНЕЦ КАК Контрагент,
	|		ВЫБОР
	|			КОГДА ЗаказыПоставщикам.ЗаказПоставщику.Ссылка ССЫЛКА Документ.ЗаказДавальца
	|				ТОГДА ДокЗаказДавальца.Договор
	|			КОГДА ЗаказыПоставщикам.ЗаказПоставщику.Ссылка ССЫЛКА Документ.ЗаказПоставщику
	|				ТОГДА ДокЗаказПоставщику.Договор
	|			КОГДА ЗаказыПоставщикам.ЗаказПоставщику.Ссылка ССЫЛКА Документ.ЗаказПереработчику
	|				ТОГДА ДокЗаказПереработчику.Договор
	|			КОГДА ЗаказыПоставщикам.ЗаказПоставщику.Ссылка ССЫЛКА Документ.ЗаказНаПроизводство
	|				ТОГДА NULL		// fix Suetin 12.05.2021 15:01:17	ДокЗаказНаПроизводство.Договор
	|			ИНАЧЕ NULL
	|		КОНЕЦ КАК Договор,
	|		ВЫБОР
	|			КОГДА ЗаказыПоставщикам.ЗаказПоставщику.Ссылка ССЫЛКА Документ.ЗаказДавальца
	|				ТОГДА ДокЗаказДавальца.НаправлениеДеятельности
	|			КОГДА ЗаказыПоставщикам.ЗаказПоставщику.Ссылка ССЫЛКА Документ.ЗаказПоставщику
	|				ТОГДА ДокЗаказПоставщику.НаправлениеДеятельности
	|			КОГДА ЗаказыПоставщикам.ЗаказПоставщику.Ссылка ССЫЛКА Документ.ЗаказПереработчику
	|				ТОГДА ДокЗаказПереработчику.НаправлениеДеятельности
	|			КОГДА ЗаказыПоставщикам.ЗаказПоставщику.Ссылка ССЫЛКА Документ.ЗаказНаПроизводство
	|				ТОГДА ДокЗаказНаПроизводство.НаправлениеДеятельности
	|			ИНАЧЕ NULL
	|		КОНЕЦ КАК НаправлениеДеятельности,
	|		ЗаказыПоставщикам.ЗаказПоставщику,
	|		ВЫБОР
	|			КОГДА ЗаказыПоставщикам.ЗаказПоставщику.Ссылка ССЫЛКА Документ.ЗаказДавальца
	|				ТОГДА ДокЗаказДавальца.Валюта
	|			КОГДА ЗаказыПоставщикам.ЗаказПоставщику.Ссылка ССЫЛКА Документ.ЗаказПоставщику
	|				ТОГДА ДокЗаказПоставщику.Валюта
	|			КОГДА ЗаказыПоставщикам.ЗаказПоставщику.Ссылка ССЫЛКА Документ.ЗаказПереработчику
	|				ТОГДА ДокЗаказПереработчику.Валюта
	|			КОГДА ЗаказыПоставщикам.ЗаказПоставщику.Ссылка ССЫЛКА Документ.ЗаказНаПроизводство
	|				ТОГДА NULL		// fix Suetin 12.05.2021 15:01:17	ДокЗаказНаПроизводство.Валюта
	|			ИНАЧЕ NULL
	|		КОНЕЦ КАК Валюта,
	...
	|		ЗаказыПоставщикам.ЗаказаноРасход,
	//|		ЗаказыПоставщикам.ЗаказаноКонечныйОстаток,
	|		ВЫБОР КОГДА ЗаказыПоставщикам.Регистратор = НЕОПРЕДЕЛЕНО
	|				ТОГДА ЗаказыПоставщикам.ЗаказаноКонечныйОстаток
	|			ИНАЧЕ 0
	|		КОНЕЦ,
	|		ВЫБОР КОГДА ТИПЗНАЧЕНИЯ(ЗаказыПоставщикам.Регистратор) В (&ТипыДокументовНеЗаказы)
	|				ТОГДА ЗаказыПоставщикам.Период
	|			ИНАЧЕ ДАТАВРЕМЯ(1, 1, 1)
	|		КОНЕЦ
	|	ИЗ
	|		РегистрНакопления.ЗаказыПоставщикам.ОстаткиИОбороты({(&НачалоВремен)}, {(&КонецПериодаГраница)}	, Регистратор, , ЗаказПоставщику В
	|				(ВЫБРАТЬ РАЗЛИЧНЫЕ
	|					Т.ОбъектРасчетов
	|				ИЗ
	|					РасчетыПредварительнаяСвернутая КАК Т)    // fix Suetin 12.05.2021 13:47:30	 РасчетыПредварительная
	|																										) КАК ЗаказыПоставщикам
	|		ЛЕВОЕ СОЕДИНЕНИЕ Документ.ЗаказДавальца КАК ДокЗаказДавальца
	|		ПО ЗаказыПоставщикам.ЗаказПоставщику = ДокЗаказДавальца.Ссылка
	|		ЛЕВОЕ СОЕДИНЕНИЕ Документ.ЗаказПоставщику КАК ДокЗаказПоставщику
	|		ПО ЗаказыПоставщикам.ЗаказПоставщику = ДокЗаказПоставщику.Ссылка
	|		ЛЕВОЕ СОЕДИНЕНИЕ Документ.ЗаказПереработчику КАК ДокЗаказПереработчику
	|		ПО ЗаказыПоставщикам.ЗаказПоставщику = ДокЗаказПереработчику.Ссылка
	|		ЛЕВОЕ СОЕДИНЕНИЕ Документ.ЗаказНаПроизводство КАК ДокЗаказНаПроизводство
	|		ПО ЗаказыПоставщикам.ЗаказПоставщику = ДокЗаказНаПроизводство.Ссылка
	|	ГДЕ
	|		ЗаказыПоставщикам.ЗаказПоставщику.Партнер <> ЗНАЧЕНИЕ(Справочник.Партнеры.НашеПредприятие)
	|	{ГДЕ
	|		ЗаказыПоставщикам.ЗаказПоставщику.Организация.* КАК Организация,
	...
	ТекстЗапроса = СтрЗаменить(ТекстЗапроса,"&ТипыДокументовНеЗаказы", ПолучитьТипыДокументовНеЗаказы());
...
Функция ПолучитьТипыДокументовНеЗаказы()

	ТекстТиповДокументов = ""; 
	
	//++ НЕ УТ
	ТекстТиповДокументов = ТекстТиповДокументов + "ТИП(Документ.КорректировкаРегистров), ";
	//-- НЕ УТ
	
	ТекстТиповДокументов = ТекстТиповДокументов + "ТИП(Документ.ОтчетПереработчика), ";
	ТекстТиповДокументов = ТекстТиповДокументов + "ТИП(Документ.ПоступлениеОтПереработчика), ";
	ТекстТиповДокументов = ТекстТиповДокументов + "ТИП(Документ.ПоступлениеСырьяОтДавальца), ";
	ТекстТиповДокументов = ТекстТиповДокументов + "ТИП(Документ.ПриемкаТоваровНаХранение), ";
	ТекстТиповДокументов = ТекстТиповДокументов + "ТИП(Документ.ПриобретениеТоваровУслуг), ";
	ТекстТиповДокументов = ТекстТиповДокументов + "ТИП(Документ.ЭтапПроизводства2_2)";
...
Процедура ДобавитьОтборыВыбранныхПолейВЗапрос(ТекстЗапроса, НастройкиОтчета, ВычисляемыеПоля, ИмяТаблицы) Экспорт    
	...
	Для Каждого ВыбранноеПоле Из МассивВыбранныхПолей Цикл
		Если ВычисляемыеПоля.Найти(Строка(ВыбранноеПоле.Поле)) = Неопределено Тогда
			...
			Если СтрЧислоВхождений(Строка(ВыбранноеПоле.Поле), "ДатаПоступления") > 0 Тогда Продолжить; КонецЕсли;
