...
// end fix Suetin 30.04.2021 13:48:07
	...
	|		ЗаказыПоставщикам.ЗаказаноРасход,
	|		ЗаказыПоставщикам.ЗаказаноКонечныйОстаток,
	|		ВЫБОР КОГДА ТИПЗНАЧЕНИЯ(ЗаказыПоставщикам.Регистратор) В (&ТипыДокументовЗаказы)
	|				ТОГДА ДАТАВРЕМЯ(1, 1, 1)
	|			ИНАЧЕ ЗаказыПоставщикам.Период
	|		КОНЕЦ
	|	ИЗ
	...
	ТекстЗапроса = СтрЗаменить(ТекстЗапроса,"&ТипыДокументовЗаказы", ПолучитьТипыДокументовЗаказы());
...
Функция ПолучитьТипыДокументовЗаказы()
