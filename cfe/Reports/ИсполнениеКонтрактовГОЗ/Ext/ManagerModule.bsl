...
#Область РаспределениеСредствКонтракта
	...
	ОтборОборотов = ОтборОборотов();
	ОтборОборотов.Счет = ПолучитьСчетСебестоимостьПродажНеЕНВД();//FIX Клещ А.Н. СчетаУчетаПроизводство;
	//FIX Клещ А.Н.ОтборОборотов.Субконто1 = Перечисления.ТипыЗатратРегл.Прочее;
	ОтборОборотов.НаправлениеДеятельности = "Контракт";//FIX Клещ А.Н.ОтборОборотов.НаправлениеДеятельности = "Контракт";
