...
#Вставка
	|	ВЫРАЗИТЬ(ДанныеДокументов.ДополнительнаяИнформацияПоДоставке КАК СТРОКА(100)) КАК ДополнительнаяИнформацияПоДоставке,     // begin fix Suetin 02.09.2020 11:09:03
	|	ДанныеДокументов.Договор				  КАК Договор,                                                    // end fix Suetin 02.09.2020 11:09:11
#КонецВставки
