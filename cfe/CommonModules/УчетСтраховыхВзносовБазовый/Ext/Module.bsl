...
Процедура ВИЛС_СформироватьВТНачисленияСДаннымиУчета(Организация, ПериодРегистрации, МенеджерВременныхТаблиц, ИспользоватьОсобыеУсловияТруда = Ложь) Экспорт 
	...
	ТекстЗапроса = ?(ПериодРегистрации<Дата('20200101'),СтрЗаменить(ТекстЗапроса,"&КлассУсловийТруда","Значение(Перечисление.КлассыУсловийТрудаПоРезультатамСпециальнойОценки.ПустаяСсылка) КАК КлассУсловийТруда"),СтрЗаменить(ТекстЗапроса,"&КлассУсловийТруда","ДанныеУчета.КлассУсловийТруда"));
