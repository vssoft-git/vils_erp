...
Процедура ВИЛС_ПоместитьВременнуюТаблицуТоваров(МенеджерВременныхТаблиц, Знач ТекущееЗаданиеНаПеревозку) Экспорт
	...
	Запрос.Текст = "
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
	//|   NULL                        КАК ТранспортнаяНакладная,
	//|   NULL                        КАК НомерСтрокиВТранспортнойНакладной,
...
Процедура ВИЛС_ПоместитьВременнуюТаблицуТоваровПродолжение(МенеджерВременныхТаблиц) Экспорт
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	//|   Распоряжения.ТранспортнаяНакладная                  КАК ТранспортнаяНакладная,
	//|   Распоряжения.НомерСтрокиВТранспортнойНакладной		КАК НомерСтрокиВТранспортнойНакладной,
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	//|   ТаблицаТоварыКДоставке.ТранспортнаяНакладная                  КАК ТранспортнаяНакладная,
	//|   ТаблицаТоварыКДоставке.НомерСтрокиВТранспортнойНакладной		КАК НомерСтрокиВТранспортнойНакладной,
	...
	|
	|ВЫБРАТЬ
	//|   ТаблицаТоварыВЗаказах.ТранспортнаяНакладная                  КАК ТранспортнаяНакладная,
	//|   ТаблицаТоварыВЗаказах.НомерСтрокиВТранспортнойНакладной		КАК НомерСтрокиВТранспортнойНакладной,
	...
	|	
	|	СГРУППИРОВАТЬ ПО
	//|   	ТаблицаТоварыКДоставке.ТранспортнаяНакладная,
	//|   	ТаблицаТоварыКДоставке.НомерСтрокиВТранспортнойНакладной,
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	//|   ТаблицаТоваров.ТранспортнаяНакладная                  КАК ТранспортнаяНакладная,
	//|   ТаблицаТоваров.НомерСтрокиВТранспортнойНакладной		КАК НомерСтрокиВТранспортнойНакладной,
