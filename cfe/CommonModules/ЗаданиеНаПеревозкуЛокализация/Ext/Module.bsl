...
//				ВИЛС_ОбработкаЗаполненияПродолжение(Объект, Основание)
//			КонецЕсли;
//		КонецЦикла;
//	ИначеЕсли ТипЗнч(ДанныеЗаполнения) = Тип("ДокументСсылка.ЗаказПоставщику") Тогда
//		ВИЛС_ОбработкаЗаполненияПродолжение(Объект, ДанныеЗаполнения)
//	Иначе
//		Возврат;
//	КонецЕсли;
//КонецПроцедуры

//Процедура ВИЛС_ОбработкаЗаполненияПродолжение(Объект, ДанныеЗаполнения)
...
//	НоваяСтрокаМ.Распоряжение = ДанныеЗаполнения;
//	
//КонецПроцедуры	
