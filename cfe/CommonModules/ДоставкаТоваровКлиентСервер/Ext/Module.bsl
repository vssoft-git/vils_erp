...
&Вместо("УстановитьСтраницуДоставки")
Процедура ВИЛС_УстановитьСтраницуДоставки(ЭлементыФормы, СпособДоставки, ИспользоватьЗаданияНаПеревозкуДляУчетаДоставкиПеревозчиками, ЭтоРаспоряжениеПоСоглашению, ЭтоРаспоряжениеПоДоговору)
...
Функция ВИЛС_СпособыДоставкиДоКлиентаСНашимУчастием(ИспользоватьЗаданияНаПеревозкуДляУчетаДоставкиПеревозчиками)
