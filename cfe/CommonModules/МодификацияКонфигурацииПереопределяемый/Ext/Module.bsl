...
Процедура ВИЛС_ПриСозданииНаСервере(Форма, Отказ, СтандартнаяОбработка)
	...
	//	Форма.УстановитьДействие("ОбработкаЗаписиНового", "МодификацияКонфигурацииПереопределяемый.ОбработкаЗаписиНовогоЭлементаСправочникаНаправленияДеятельности");
...
Процедура ВИЛС_ПослеЗаписиНаСервере(Форма, ТекущийОбъект, ПараметрыЗаписи)
	Если Форма.ИмяФормы	= "Справочник.НаправленияДеятельности.Форма.ФормаЭлемента" Тогда
		...
		//Если Не ЗначениеЗаполнено(ТекущийОбъект.Ссылка) Тогда
			//Форма.ОповеститьОЗаписиНового(ТекущийОбъект);
...
////                 <продолжение описания параметра>
////
//Процедура ОбработкаЗаписиНовогоЭлементаСправочникаНаправленияДеятельности(НовыйОбъект, Источник, СтандартнаяОбработка) Экспорт
//	ОбщегоНазначенияКлиентСервер.СообщитьПользователю(НСтр("ru = 'В справочнике Статьи расходов необходимо внести изменения
//		|в Правила распределения между направлениями деятельности.'"), НовыйОбъект);
//	

//КонецПроцедуры // ОбработкаЗаписиНовогоЭлементаСправочникаНаправленияДеятельности()
