...
Процедура ВИЛС_ПриСозданииНаСервере(Форма, Отказ, СтандартнаяОбработка)
	...
	ИначеЕсли Форма.ИмяФормы	= "Документ.ЗаявкаНаРасходованиеДенежныхСредств.Форма.ФормаСпискаДокументов" Тогда
		...
		ОператорыПакетЗапроса_0.ВыбираемыеПоля.Добавить("Заявка.ВИЛС_Исполнитель",0);
		ОператорыПакетЗапроса_0.ВыбираемыеПоля.Добавить("Выразить(Заявка.НазначениеПлатежа как Строка(300))",0);
		ПакетЗапроса_0.Колонки[0].Псевдоним = "ВИЛС_НазначениеПлатежа";
		ПакетЗапроса_0.Колонки[1].Псевдоним = "ВИЛС_Исполнитель";
		
		//НовыйРеквизит = Новый РеквизитФормы("ВИЛС_Исполнитель",Новый ОписаниеТипов("Строка"),"Список","Исполнитель",0);
		//МассивРеквизитов = Новый Массив;
		//НовыйРеквизит = Новый РеквизитФормы("ВИЛС_НазначениеПлатежа",Новый ОписаниеТипов("Строка"),"Список","Назначение платежа");
		//МассивРеквизитов = Новый Массив;
