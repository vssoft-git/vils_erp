...
Функция ВИЛС_СформироватьОтчет(Знач Параметры, Знач ПроверятьЗаполнение, Знач ПолучатьФлажокПустой)
	...
	Если ПроверятьЗаполнение Тогда
		...
		Если Не ПроверкаПройдена Тогда
			...
			|en = 'Report did not pass the population check:'");
	...
	Исключение
		...
		|en = 'Cannot determine the used tables:'");
...
#Вставка
	...
	Если ТипЗнч(ПараметрДанных) = Тип("ЗначениеПараметраНастроекКомпоновкиДанных") 
		...
		НастройкиКолонтитулов.ВерхнийКолонтитул.Вставить("ВыводитьКолонтитул", Не ПараметрДанных.Значение);
		НастройкиКолонтитулов.НижнийКолонтитул.Вставить("ВыводитьКолонтитул", Не ПараметрДанных.Значение)
	КонецЕсли;
