...
Функция ПолучитьДанныеДляПечатнойФормыМ15(ПараметрыПечати, МассивОбъектов) Экспорт
	...
	|	ЕСТЬNULL(ПередачаТоваров.Руководитель.Наименование, ТаблицаОтветственныеЛица.РуководительНаименование) КАК Руководитель,            	// begin fix Suetin 27.08.2019 17:11:30
	|	ЕСТЬNULL(ПередачаТоваров.Руководитель.Должность, ТаблицаОтветственныеЛица.РуководительДолжность)       КАК ДолжностьРуководителя,
	|	ЕСТЬNULL(ПередачаТоваров.ГлавныйБухгалтер.Наименование, ТаблицаОтветственныеЛица.ГлавныйБухгалтерНаименование) КАК ГлавныйБухгалтер  	// end fix Suetin 27.08.2019 17:12:36
	|ИЗ
