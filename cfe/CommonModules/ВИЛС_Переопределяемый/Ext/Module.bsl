...
Процедура ВИЛС_ВИЛС_СборДанныхПоСогласованию() Экспорт
	...
	Попытка 
		...
		ПроксиПроверка = ИнтеграцияС1СДокументооборот.ПолучитьПрокси(,"Клещ Антон Николаевич","Qwe12345",Ложь);
...
Функция ПроверитьДокумент(СсылкаНаОбъект,Прокси)
...
Функция ВернутьСледующегоПользователя(Предмет,Прокси) 
