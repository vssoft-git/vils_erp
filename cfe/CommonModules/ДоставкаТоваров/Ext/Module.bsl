...
Процедура ВИЛС_ПриИзмененииСпособаДоставки(ЭлементыФормы, ДокОбъект)
	...
	ИначеЕсли (РеквизитыДоставки.СпособДоставки = Перечисления.СпособыДоставки.НашимиСиламиСАдресаОтправителя
		...
		И ЗначениеЗаполнено(ДокОбъект.Контрагент) Тогда	
		ВИЛС_ЗаполнитьСписокВыбораАдресовКонтрагентаПоКонтрагенту(ЭлементыФормы, ДокОбъект.Контрагент);                               
		ЗаполнитьРеквизитыПоПеревозчику(ЭлементыФормы, РеквизитыДоставки, ДопИнфоИзмененоПользователем);			
...
Процедура ВИЛС_ЗаполнитьСписокВыбораАдресовКонтрагентаПоКонтрагенту(ЭлементыФормы, Знач Контрагент, Знач ИмяЭлементаАдрес = "АдресПоставщика", Знач ОчиститьСписок = Истина)	Экспорт
	УстановитьПривилегированныйРежим(Истина);
...
Процедура ВИЛС_СкопироватьСписокЗначений(СписокПриемник, СписокИсточник, Знач ОчиститьСписок = Истина)
