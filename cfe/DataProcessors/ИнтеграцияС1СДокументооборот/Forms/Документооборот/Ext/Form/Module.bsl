...
Процедура ИзменитьДоступностьСозданиеЗадачи()
	...
	//Если ТипЗнч(ЭтаФорма.ВнешнийОбъект) = Тип("ДокументСсылка.ЗаявкаНаРасходованиеДенежныхСредств") и (этаФорма.ВнешнийОбъект.Статус = Перечисления.СтатусыЗаявокНаРасходованиеДенежныхСредств.Отклонена 
	...
	Если ТипЗнч(ЭтаФорма.ВнешнийОбъект) = Тип("ДокументСсылка.ЗаявкаНаРасходованиеДенежныхСредств") и Не ЭтаФорма.ВнешнийОбъект.Проведен Тогда
...
&НаКлиенте
Процедура ВИЛС_ПриПовторномОткрытииПосле()
	ИзменитьДоступностьСозданиеЗадачи()
КонецПроцедуры
//<<Ищем следующего исполнителя
