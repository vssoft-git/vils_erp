...
Процедура ВИЛС_ПриСозданииНаСервереПосле(Отказ, СтандартнаяОбработка)
	ДобавляемыйЭлемент = Элементы.Вставить("ДополнительнаяИнформацияПоДоставке", Тип("ПолеФормы"), Элементы.ГруппаДоверенность); 													 
	ДобавляемыйЭлемент.Вид 				= ВидПоляФормы.ПолеВвода; 
   	ДобавляемыйЭлемент.ПутьКДанным 		= "ДополнительнаяИнформацияПоДоставке";
