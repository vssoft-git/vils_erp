...
//&Вместо("ПроверитьЗаполнениеОбъекта")
...
//	
//	//Сообщить(МассивНепроверяемыхРеквизитов.Найти("ВыходныеИзделия.Назначение"));
//	//Сообщить(МассивНепроверяемыхРеквизитов.Найти("ПобочныеИзделия.Назначение"));
//	//Сообщить(ПроверяемыеРеквизиты.Найти("ВыходныеИзделия.Назначение"));
//	//Сообщить(ПроверяемыеРеквизиты.Найти("ПобочныеИзделия.Назначение"));
//	//Сообщить(Отказ);
...
//	//КонецЕсли;
//	//
//	//Инд = ПроверяемыеРеквизиты.Найти("ПобочныеИзделия.Назначение");
//	//Если Не Инд = Неопределено Тогда
//	//	ПроверяемыеРеквизиты.Удалить(Инд);
//	//КонецЕсли;
//КонецПроцедуры
