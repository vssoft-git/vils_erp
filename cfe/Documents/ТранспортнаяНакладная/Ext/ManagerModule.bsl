#Если Сервер  Или ВнешнееСоединение Тогда    //  Или ТолстыйКлиентОбычноеПриложение
	
#Область ПрограммныйИнтерфейс

&Вместо("ПолучитьИнформациюТранспортныхНакладных")
Функция ВИЛС_ПолучитьИнформациюТранспортныхНакладных(ДокументСсылка)
	...
	|ГДЕ
	//|	ТранспортнаяНакладная.ДокументыОснования.ДокументОснование = &ДокументОснование           // begin fix Suetin 26.09.2019 16:54:51
	|	ТранспортнаяНакладная.ДокументыОснования.ВИЛС_ДокументОснование = &ДокументОснование      // end fix Suetin 26.09.2019 16:54:54
	...
	|	Документ.ТранспортнаяНакладная КАК ТранспортнаяНакладная
	|ГДЕ
	//|	ТранспортнаяНакладная.ДокументыОснования.ДокументОснование = &ДокументОснование            // begin fix Suetin 26.09.2019 16:54:59
	|	ТранспортнаяНакладная.ДокументыОснования.ВИЛС_ДокументОснование = &ДокументОснование       // end fix Suetin 26.09.2019 16:55:02
	|	И ТранспортнаяНакладная.Проведен
	|	И НЕ ТранспортнаяНакладная.ПометкаУдаления";
...
Функция ВИЛС_ПроверитьНаличиеТранспортныхНакладныхДляРаспоряженийИзЗаданийНаПеревозку(МассивЗаданийНаПеревозку)
	...
	//|		ПО Таблица.Накладная = ТранспортнаяНакладнаяДокументыОснования.ДокументОснование              // begin fix Suetin 26.09.2019 17:03:16
	|		ПО Таблица.Накладная = ТранспортнаяНакладнаяДокументыОснования.ВИЛС_ДокументОснование         // end fix Suetin 26.09.2019 17:03:27
...
&Вместо("ПроверитьНаличиеТранспортныхНакладныхДляРаспоряжений")
Функция ВИЛС_ПроверитьНаличиеТранспортныхНакладныхДляРаспоряжений(МассивОбъектов)
	...
	Запрос.Текст = 
	"ВЫБРАТЬ РАЗЛИЧНЫЕ
	//|	ТранспортнаяНакладнаяДокументыОснования.ДокументОснование КАК ДокументОснование           	// begin fix Suetin 26.09.2019 17:07:43
	|	ТранспортнаяНакладнаяДокументыОснования.ВИЛС_ДокументОснование КАК ДокументОснование      	// end fix Suetin 26.09.2019 17:07:47
	|ИЗ
	|	Документ.ТранспортнаяНакладная.ДокументыОснования КАК ТранспортнаяНакладнаяДокументыОснования
	|ГДЕ
	//|	ТранспортнаяНакладнаяДокументыОснования.ДокументОснование В(&МассивОбъектов)             	// begin fix Suetin 26.09.2019 17:08:08
	|	ТранспортнаяНакладнаяДокументыОснования.ВИЛС_ДокументОснование В(&МассивОбъектов)       	// end fix Suetin 26.09.2019 17:08:12
	|	И ТранспортнаяНакладнаяДокументыОснования.Ссылка.Проведен
	...
	|	НЕОПРЕДЕЛЕНО,
	|	ОтгрузкаТоваровСХранения.СпособДоставки,
	|	НЕОПРЕДЕЛЕНО,
	|	""НеверныйСпособДоставки""
	|ИЗ
	...
	|	И ОтгрузкаТоваровСХранения.СпособДоставки В (&СпособыДоставкиСНашимУчастием)
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
	...
	|	НЕОПРЕДЕЛЕНО,
	|	ПередачаТоваровХранителю.СпособДоставки,
	|	НЕОПРЕДЕЛЕНО,
	|	""НеверныйСпособДоставки""
	|ИЗ
	|	Документ.ПередачаТоваровХранителю КАК ПередачаТоваровХранителю
	|ГДЕ
	|	НЕ ПередачаТоваровХранителю.ПередачаПоЗаказам
	|	И ПередачаТоваровХранителю.Ссылка В(&МассивОбъектов)
	|	И ПередачаТоваровХранителю.СпособДоставки В (&СпособыДоставкиСНашимУчастием)
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
	...
	|	ПередачаТоваровХранителюТовары.ЗаказКлиента.СпособДоставки,
	|	НЕОПРЕДЕЛЕНО,
	|	""НеверныйСпособДоставки""
	|ИЗ
	|	Документ.ПередачаТоваровХранителю.Товары КАК ПередачаТоваровХранителюТовары
	|ГДЕ
	|	ПередачаТоваровХранителюТовары.Ссылка.ПередачаПоЗаказам
	|	И ПередачаТоваровХранителюТовары.Ссылка В(&МассивОбъектов)
	|	И ПередачаТоваровХранителюТовары.ЗаказКлиента.СпособДоставки В(&СпособыДоставкиСНашимУчастием)
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
	...
	|en = 'The ""%СпособДоставки%"" delivery method is specified in the ""%Документ%"" document. You can print the consignment note from the transportation job. '");
	...
	|en = 'Cannot print a consignment note for document ""%Документ%"" as it has ""%ДокументОснование%"" as a base document.'");
	...
	|en = 'The ""%СпособДоставки%"" transportation method is specified in the ""%Заказ%"" order from the ""%Документ%"" consignment note. In such case you can a print consignment note from the transportation job.'");
	...
	Пока Выборка.Следующий() Цикл
		...
		Иначе
			...
			|en = 'Unknown issue description is received. Contact the administrator. '");
...
&Вместо("СоздатьТранспортныеНакладныеДляЗаданийНаПеревозку")
...
Функция ВИЛС_СоздатьТранспортныеНакладные(МассивОбъектов, ЭтоПечать)
	...
	|	ОБЪЕДИНИТЬ ВСЕ
	|
	// begin fix Suetin 03.02.2021 2:20:55
	|	ВЫБРАТЬ
	|		Документ.Ссылка КАК Ссылка,
	|		Документ.АдресДоставки КАК АдресДоставки,
	|		ВЫБОР
	...
	//|		КОНЕЦ
	//|	ИЗ
	//|		Документ.РеализацияУслугПрочихАктивов.Товары КАК ДокументТовары
	//|	ГДЕ
	//|		ДокументТовары.Ссылка В(&МассивОбъектов)
	////|		И ДокументТовары.Ссылка.РеализацияПоЗаказам
	//|		И НЕ ДокументТовары.ЗаказКлиента.СпособДоставки В (&СпособыДоставкиСНашимУчастием)
	...
	//|	ОБЪЕДИНИТЬ ВСЕ
	//|
	 // end fix Suetin 03.02.2021 2:21:11
	|	ВЫБРАТЬ
	|		Документ.Ссылка,
...
//-- НЕ УТ
	...
	|		ЛЕВОЕ СОЕДИНЕНИЕ Документ.ТранспортнаяНакладная.ДокументыОснования КАК ТранспортнаяНакладнаяДокументыОснования
	//|		ПО ПараметрыТТН.Ссылка = ТранспортнаяНакладнаяДокументыОснования.ДокументОснование           // begin fix Suetin 26.09.2019 17:14:58
	|		ПО ПараметрыТТН.Ссылка = ТранспортнаяНакладнаяДокументыОснования.ВИЛС_ДокументОснование      // end fix Suetin 26.09.2019 17:15:02
	|ГДЕ
	|	(ТранспортнаяНакладнаяДокументыОснования.Ссылка ЕСТЬ NULL 
	|			ИЛИ НЕ &ЭтоПечать)
	|
...
Функция ВИЛС_ПолучитьТолькоДокументыОснованияСТоварами(МассивВсехРаспоряжений, Отказ, ТекущееЗаданиеНаПеревозку) Экспорт
	...
	|	ДанныеДокументов.Ссылка В(&МассивОбъектов)
	|
	|ОБЪЕДИНИТЬ ВСЕ  												// begin fix Suetin 13.11.2019 17:00:48
	|
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
	|	ДанныеДокументов.Ссылка,
	|	ДанныеДокументов.Валюта,
	...
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|                												// end fix Suetin 13.11.2019 17:00:57
	|ВЫБРАТЬ         												// begin fix Suetin 19.09.2019 12:50:30
	...
	|   И ДанныеДокументов.Ссылка = &ТекущееЗаданиеНаПеревозку    	// end fix Suetin 19.09.2019 12:50:36
	...
	РеализацияУслугПрочихАктивовЛокализация.ПоместитьВременнуюТаблицуТоваров(МенеджерВременныхТаблиц);                              // fix Suetin 13.11.2019 17:08:28
	//++ НЕ УТКА
...
//-- НЕ УТКА
	...
	|	ДокументТовары.ЭтоТовар
	|
	|ОБЪЕДИНИТЬ ВСЕ                        	// begin fix Suetin 13.11.2019 17:03:31
	|
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
	|	ДокументТовары.Ссылка
	|ИЗ
	|	РеализацияУслугПрочихАктивовТаблицаТоваров КАК ДокументТовары
	|ГДЕ
	|	ДокументТовары.ВнеоборотныйАктив
	|   
	|ОБЪЕДИНИТЬ ВСЕ   // begin fix Suetin 20.09.2019 10:56:13
	|
	|ВЫБРАТЬ РАЗЛИЧНЫЕ                      // end fix Suetin 13.11.2019 17:03:37
	...
	|ГДЕ
	|	ДокументТовары.ЭтоТовар             // end fix Suetin 20.09.2019 10:56:23
	|";   
...
&Вместо("УдалитьРаспоряжениеИзТранспортныхНакладных")
Процедура ВИЛС_УдалитьРаспоряжениеИзТранспортныхНакладных(Распоряжение)
	...
	|	Документ.ТранспортнаяНакладная.ДокументыОснования КАК ТранспортнаяНакладнаяДокументыОснования
	|ГДЕ
	//|	ТранспортнаяНакладнаяДокументыОснования.ДокументОснование = &ДокументОснование      	// begin fix Suetin 26.09.2019 17:22:18
	|	ТранспортнаяНакладнаяДокументыОснования.ВИЛС_ДокументОснование = &ДокументОснование  	// end fix Suetin 26.09.2019 17:22:22
	|	И НЕ ТранспортнаяНакладнаяДокументыОснования.Ссылка.ПометкаУдаления";
...
&Вместо("ТекстЗапросаПроверкиЗаданийНаПеревозкуНаНаличиеТранспортныхНакладных")
Функция ВИЛС_ТекстЗапросаПроверкиЗаданийНаПеревозкуНаНаличиеТранспортныхНакладных()
	...
	|	СУММА(ВЫБОР
	//|			КОГДА ТранспортнаяНакладнаяДокументыОснованияОснования.ДокументОснование ЕСТЬ NULL              // begin fix Suetin 26.09.2019 17:24:46
	|			КОГДА ТранспортнаяНакладнаяДокументыОснованияОснования.ВИЛС_ДокументОснование ЕСТЬ NULL         // end fix Suetin 26.09.2019 17:24:49
	|				ТОГДА 1
	|			ИНАЧЕ 0
	...
	//|				И (ТранспортнаяНакладнаяДокументыОснованияОснования.ДокументОснование = Накладные.Накладная)         // begin fix Suetin 26.09.2019 17:24:39
	|				И (ТранспортнаяНакладнаяДокументыОснованияОснования.ВИЛС_ДокументОснование = Накладные.Накладная)    // end fix Suetin 26.09.2019 17:24:42
	|				И (ТранспортнаяНакладнаяДокументыОснованияОснования.Ссылка.Проведен)
...
Функция ВИЛС_ПолучитьДанныеДляПечатнойФормыТранспортнаяНакладная(ТаблицаНакладных)
	...
	|	ТаблицаНакладных.ПорядковыйНомер КАК ПорядковыйНомер,
	//|	ТранспортнаяНакладнаяДокументыОснования.ДокументОснование КАК ДокументОснование,       							// begin fix Suetin 26.09.2019 15:45:41   ДокументОснование -> ВИЛС_ДокументОснование
	//|	ТранспортнаяНакладнаяДокументыОснования.ДокументОснование.Проведен КАК ДокументОснованиеПроведен,
	|	ТранспортнаяНакладнаяДокументыОснования.ВИЛС_ДокументОснование КАК ДокументОснование,                           // ДокументОснование -> ВИЛС_ДокументОснование
	|	ТранспортнаяНакладнаяДокументыОснования.ВИЛС_ДокументОснование.Проведен КАК ДокументОснованиеПроведен,
	|	ВЫБОР
	|		КОГДА НЕ ДокументТранспортнаяНакладная.ЗаданиеНаПеревозку.Операция ЕСТЬ NULL
	|				И ДокументТранспортнаяНакладная.ЗаданиеНаПеревозку.Операция = ЗНАЧЕНИЕ(Перечисление.ВидыДоставки.НаСклад)
	|			ТОГДА ЕСТЬNULL(ДокументТранспортнаяНакладная.ЗаданиеНаПеревозку.ВИЛС_НомерЗаявки, ТранспортнаяНакладнаяДокументыОснования.ВИЛС_ДокументОснование.Номер)
	|		ИНАЧЕ ТранспортнаяНакладнаяДокументыОснования.ВИЛС_ДокументОснование.Номер
	|	КОНЕЦ КАК ДокументОснованиеНомер,
	|	ВЫБОР
	|		КОГДА НЕ ДокументТранспортнаяНакладная.ЗаданиеНаПеревозку.Операция ЕСТЬ NULL
	|				И ДокументТранспортнаяНакладная.ЗаданиеНаПеревозку.Операция = ЗНАЧЕНИЕ(Перечисление.ВидыДоставки.НаСклад)
	|			ТОГДА ЕСТЬNULL(ДокументТранспортнаяНакладная.ЗаданиеНаПеревозку.ВИЛС_ДатаЗаявки, ТранспортнаяНакладнаяДокументыОснования.ВИЛС_ДокументОснование.Дата)
	|		ИНАЧЕ ТранспортнаяНакладнаяДокументыОснования.ВИЛС_ДокументОснование.Дата
	|	КОНЕЦ КАК ДокументОснованиеДата,
	|	ВЫБОР
	|		КОГДА НЕ ДокументТранспортнаяНакладная.ЗаданиеНаПеревозку.Операция ЕСТЬ NULL
	|				И ДокументТранспортнаяНакладная.ЗаданиеНаПеревозку.Операция = ЗНАЧЕНИЕ(Перечисление.ВидыДоставки.НаСклад)
	|			ТОГДА ЕСТЬNULL(ДокументТранспортнаяНакладная.ЗаданиеНаПеревозку.ДатаВремяРейсаПланС, НЕОПРЕДЕЛЕНО)
	|		ИНАЧЕ НЕОПРЕДЕЛЕНО
	|	КОНЕЦ КАК ДокументОснованиеНачалоРейсаПлан,
	|	ВЫБОР
	|		КОГДА НЕ ДокументТранспортнаяНакладная.ЗаданиеНаПеревозку.Операция ЕСТЬ NULL
	|				И ДокументТранспортнаяНакладная.ЗаданиеНаПеревозку.Операция = ЗНАЧЕНИЕ(Перечисление.ВидыДоставки.НаСклад)
	|			ТОГДА ЕСТЬNULL(ДокументТранспортнаяНакладная.ЗаданиеНаПеревозку.ДатаВремяРейсаПланПо, НЕОПРЕДЕЛЕНО)
	|		ИНАЧЕ НЕОПРЕДЕЛЕНО
	|	КОНЕЦ КАК ДокументОснованиеОкончаниеРейсаПлан,  
	|	ВЫБОР
	|		КОГДА НЕ ДокументТранспортнаяНакладная.ЗаданиеНаПеревозку.Операция ЕСТЬ NULL
	|				И ДокументТранспортнаяНакладная.ЗаданиеНаПеревозку.Операция = ЗНАЧЕНИЕ(Перечисление.ВидыДоставки.НаСклад)
	|			ТОГДА ЕСТЬNULL(ДокументТранспортнаяНакладная.ЗаданиеНаПеревозку.ВИЛС_Водитель, НЕОПРЕДЕЛЕНО)
	|		ИНАЧЕ НЕОПРЕДЕЛЕНО
	|	КОНЕЦ КАК ФИОВодителя,
	|	ВЫБОР
	|		КОГДА НЕ ДокументТранспортнаяНакладная.ЗаданиеНаПеревозку.Операция ЕСТЬ NULL
	|				И ДокументТранспортнаяНакладная.ЗаданиеНаПеревозку.Операция = ЗНАЧЕНИЕ(Перечисление.ВидыДоставки.НаСклад)
	|			ТОГДА КонтрагентыКИ.Представление
	|		ИНАЧЕ НЕОПРЕДЕЛЕНО
	|	КОНЕЦ КАК ТелефонВодителя,
	|	ВЫБОР
	|		КОГДА НЕ ДокументТранспортнаяНакладная.ЗаданиеНаПеревозку.Операция ЕСТЬ NULL
	|				И ДокументТранспортнаяНакладная.ЗаданиеНаПеревозку.Операция = ЗНАЧЕНИЕ(Перечисление.ВидыДоставки.НаСклад)
	|				И НЕ ЕСТЬNULL(ДокументТранспортнаяНакладная.ЗаданиеНаПеревозку.ВИЛС_НомерЗаявки,НЕОПРЕДЕЛЕНО) = НЕОПРЕДЕЛЕНО
	|			ТОГДА ""Согласно заявке №"" // + ЕСТЬNULL(ДокументТранспортнаяНакладная.ЗаданиеНаПеревозку.ВИЛС_НомерЗаявки,НЕОПРЕДЕЛЕНО) + "" от "" 
	//|					+ ДЕНЬ(ЕСТЬNULL(ДокументТранспортнаяНакладная.ЗаданиеНаПеревозку.ВИЛС_ДатаЗаявки, ДАТАВРЕМЯ(1,1,1,0,0,0))) + ""."" 
	//|					+ МЕСЯЦ(ЕСТЬNULL(ДокументТранспортнаяНакладная.ЗаданиеНаПеревозку.ВИЛС_ДатаЗаявки, ДАТАВРЕМЯ(1,1,1,0,0,0))) + ""."" 
	//|					+ ГОД(ЕСТЬNULL(ДокументТранспортнаяНакладная.ЗаданиеНаПеревозку.ВИЛС_ДатаЗаявки, ДАТАВРЕМЯ(1,1,1,0,0,0))) + ""г.""
	|		ИНАЧЕ """"
	|	КОНЕЦ КАК СтоимостьУслуги,
	//|	ЗаданиеНаПеревозкуРаспоряжения.Вес КАК ВесГруза,
	|   ЗаданиеНаПеревозкуРаспоряжения.Ссылка.ВИЛС_ГабаритыГруза КАК ВесГруза,
	|	ВЫРАЗИТЬ(ЗаданиеНаПеревозкуМаршрут.ДополнительнаяИнформация КАК СТРОКА(1000)) КАК НаименованиеВидаНоменклатуры, // end fix Suetin 09.10.2019 17:36:56
	//|	ВЫРАЗИТЬ(ДокументТранспортнаяНакладная.Комментарий КАК СТРОКА(1000)) КАК Комментарий,                           // fix Suetin 08.09.2020 12:29:38
	...
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.ТранспортнаяНакладная КАК ДокументТранспортнаяНакладная                                 // begin fix Suetin 09.10.2019 15:09:29
	|			ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.ТранспортнаяНакладная.ДокументыОснования КАК ТранспортнаяНакладнаяДокументыОснования
	|			ПО (ДокументТранспортнаяНакладная.Ссылка = ТранспортнаяНакладнаяДокументыОснования.Ссылка)
	|			ЛЕВОЕ СОЕДИНЕНИЕ Справочник.Контрагенты.КонтактнаяИнформация КАК КонтрагентыКИ
	|			ПО (ДокументТранспортнаяНакладная.ЗаданиеНаПеревозку.ВИЛС_Водитель = КонтрагентыКИ.Ссылка
	|				И КонтрагентыКИ.Тип = ЗНАЧЕНИЕ(Перечисление.ТипыКонтактнойИнформации.Телефон)
	|				И КонтрагентыКИ.Вид = ЗНАЧЕНИЕ(Справочник.ВидыКонтактнойИнформации.ТелефонКонтрагента))
	|		ПО (ТаблицаНакладных.ТранспортнаяНакладная = ДокументТранспортнаяНакладная.Ссылка)
	|		ЛЕВОЕ СОЕДИНЕНИЕ Документ.ЗаданиеНаПеревозку.Распоряжения КАК ЗаданиеНаПеревозкуРаспоряжения
	|		ПО (ТранспортнаяНакладнаяДокументыОснования.Ссылка.ЗаданиеНаПеревозку = ЗаданиеНаПеревозкуРаспоряжения.Ссылка)
	|			И (ТранспортнаяНакладнаяДокументыОснования.ВИЛС_ДокументОснование = ЗаданиеНаПеревозкуРаспоряжения.Распоряжение)
	|		ЛЕВОЕ СОЕДИНЕНИЕ Документ.ЗаданиеНаПеревозку.Маршрут КАК ЗаданиеНаПеревозкуМаршрут
	|		ПО (ЗаданиеНаПеревозкуРаспоряжения.Ссылка = ЗаданиеНаПеревозкуМаршрут.Ссылка)
	|			И (ЗаданиеНаПеревозкуРаспоряжения.КлючСвязи = ЗаданиеНаПеревозкуМаршрут.КлючСвязи)                                 // end fix Suetin 09.10.2019 11:58:29
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
...
//++ НЕ УТКА
	...
	|	ОБЪЕДИНИТЬ ВСЕ
//-- НЕ УТКА           
	// begin fix Suetin 08.10.2019 17:02:04
	|	ВЫБРАТЬ
	|		ДокументыОснования.ТранспортнаяНакладная КАК Ссылка,
	|		ДокументыОснования.ПорядковыйНомер КАК ПорядковыйНомер,
	|       ЕСТЬNULL(ДокументыОснования.ВесГруза, ДокументТовары.КоличествоУпаковок) 	КАК КоличествоУпаковок,      	// begin fix Suetin 20.02.2019 15:49:44
	|       ВЫБОР КОГДА ДокументыОснования.ВесГруза ЕСТЬ NULL ТОГДА
	|       	ВЫБОР
	|				КОГДА ДокументТовары.Номенклатура.ИспользоватьУпаковки
	|					ТОГДА ДокументТовары.Упаковка
	|				ИНАЧЕ ДокументТовары.Номенклатура.ЕдиницаИзмерения
	...
	|       ИНАЧЕ """"    //кг
	|       КОНЕЦ																		КАК Упаковка,                   // end fix Suetin 20.02.2019 15:49:52
	|		ДокументыОснования.НаименованиеВидаНоменклатуры КАК НаименованиеВидаНоменклатуры
	|	ИЗ
	|		ТаблицаТранспортныхНакладных КАК ДокументыОснования
	|			ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.ЗаказПоставщику.Товары КАК ДокументТовары
	|			ПО ДокументыОснования.ДокументОснование = ДокументТовары.Ссылка
	// end fix Suetin 08.10.2019 17:01:59
	|	ОБЪЕДИНИТЬ ВСЕ
	|
	|	ВЫБРАТЬ
	|		ДокументыОснования.ТранспортнаяНакладная,
	...
	|			ПО ДокументыОснования.ДокументОснование = ДокументТовары.Ссылка
	|			ЛЕВОЕ СОЕДИНЕНИЕ Справочник.ВидыНоменклатуры КАК ВидыНоменклатуры
	|			ПО (ВидыНоменклатуры.Ссылка = ДокументТовары.Номенклатура.ВидНоменклатуры)	// begin fix Suetin 08.09.2020 14:09:36) КАК ВнутреннийЗапрос
	|
	|	ОБЪЕДИНИТЬ ВСЕ
	|
	|	ВЫБРАТЬ
	|		ДокументыОснования.ТранспортнаяНакладная	КАК Ссылка,
	|		ДокументыОснования.ПорядковыйНомер			КАК ПорядковыйНомер,
	|       ЕСТЬNULL(ДокументТовары.Количество, 0) 		КАК КоличествоУпаковок,
	|       ДокументТовары.ЕдиницаИзмерения 			КАК Упаковка,
	|		ДокументТовары.Содержание               	КАК НаименованиеВидаНоменклатуры
	|	ИЗ
	|		ТаблицаТранспортныхНакладных КАК ДокументыОснования
	|			ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.РеализацияУслугПрочихАктивов.Доходы КАК ДокументТовары
	|			ПО ДокументыОснования.ДокументОснование = ДокументТовары.Ссылка) КАК ВнутреннийЗапрос  // end fix Suetin 08.09.2020 14:10:37
	|УПОРЯДОЧИТЬ ПО
	|	ВнутреннийЗапрос.ПорядковыйНомер,
	|	ВнутреннийЗапрос.НаименованиеВидаНоменклатуры
	...
	|	ТТН.ДокументОснованиеНомер	 			КАК Номер,
	|	ТТН.ДокументОснованиеДата 				КАК Дата,
	|	ТТН.ДокументОснованиеНачалоРейсаПлан	КАК НачалоРейсаПлан,
	|	ТТН.ДокументОснованиеОкончаниеРейсаПлан	КАК ОкончаниеРейсаПлан,
	|	ТТН.ФИОВодителя							КАК ФИОВодителя,
	|	ТТН.ТелефонВодителя 					КАК ТелефонВодителя,
	|	ТТН.СтоимостьУслуги						КАК СтоимостьУслуги	//,
	//|	ТТН.Комментарий 						КАК Комментарий       // fix Suetin 08.09.2020 12:30:40
	|ИЗ
...
Функция ВИЛС_ПолучитьДанныеДляПечатнойФормыТТН(ТаблицаНакладных)
	...
	|	ТаблицаНакладных.ТранспортнаяНакладная КАК ТранспортнаяНакладная,
	|	ТаблицаНакладных.ПорядковыйНомер КАК ПорядковыйНомер,
	//|	ТранспортнаяНакладнаяДокументыОснования.ДокументОснование КАК ДокументОснование,                      	// begin fix Suetin 26.09.2019 17:26:01
	|	ТранспортнаяНакладнаяДокументыОснования.ВИЛС_ДокументОснование КАК ДокументОснование,
	//|	ТранспортнаяНакладнаяДокументыОснования.ДокументОснование.Проведен КАК ДокументОснованиеПроведен,
	|	ТранспортнаяНакладнаяДокументыОснования.ВИЛС_ДокументОснование.Проведен КАК ДокументОснованиеПроведен,  // end fix Suetin 26.09.2019 17:26:05
	|	ТранспортнаяНакладнаяДокументыОснования.НомерСтроки КАК НомерСтрокиВТранспортнойНакладной
	|ПОМЕСТИТЬ ТаблицаТранспортныхНакладных
	|ИЗ
	|	ТаблицаТранспортныхНакладныхБезОснований КАК ТаблицаНакладных
	...
	//// begin fix Suetin 13.11.2019 17:24:36
	//|ОБЪЕДИНИТЬ ВСЕ
	//|
	//|ВЫБРАТЬ РАЗЛИЧНЫЕ
	//|	ДанныеДокументов.Ссылка КАК Ссылка,
	...
	//|		ПО (ТаблицаТранспортныхНакладных.ДокументОснование = ДанныеДокументов.Ссылка)
	//|
	//// end fix Suetin 13.11.2019 17:24:44
	|ИНДЕКСИРОВАТЬ ПО
	|	Ссылка
	|;
	|
	...
	//РеализацияУслугПрочихАктивовЛокализация.ПоместитьВременнуюТаблицуТоваров(МенеджерВременныхТаблиц);  // end fix Suetin 13.11.2019 17:26:17
	//++ НЕ УТКА
	ВозвратСырьяДавальцуЛокализация.ПоместитьВременнуюТаблицуТоваров(МенеджерВременныхТаблиц, Ложь);
	ПараметрыЗаполнения = ПродажиСервер.ПараметрыЗаполненияВременнойТаблицыТоваров();
	ПараметрыЗаполнения.ПересчитыватьВВалютуРегл = Ложь;
...
Процедура ВИЛС_ПоместитьВременнуюТаблицуТоваровДляЗаказаПоставщику(МенеджерВременныхТаблиц)
	...
	|		ПО (ТранспортнаяНакладнаяДО.ВИЛС_ДокументОснование = Распоряжения.Распоряжение)
...
КонецПроцедуры
// end fix Suetin 07.10.2019 15:48:28
#КонецОбласти
...
Процедура ВИЛС_ЗаполнитьРеквизитыТранспортнойНакладной(МассивРаспоряжений, РеквизитыТранспортнойНакладной, ЗначенияЗаполнения, ЗаданиеНаПеревозку)
	...
	|	ЕСТЬNULL(ОрганизацииКИ.Представление, """") КАК АдресДоставки,
	|	ЕСТЬNULL(ОрганизацииКИ.ЗначенияПолей, """") КАК АдресДоставкиЗначенияПолей,
	|	ЕСТЬNULL(ДанныеЗаданияНаПеревозкуЗаказы.АдресДоставки, """") КАК АдресПогрузки,
	|	ЕСТЬNULL(ДанныеЗаданияНаПеревозкуЗаказы.АдресДоставкиЗначенияПолей, """") КАК АдресПогрузкиЗначенияПолей,
	...
	|	ДокументРаспоряжение.Организация КАК Грузоотправитель,
	|	ДокументРаспоряжение.Организация КАК Грузополучатель,
	...
	|		ПО ДокументРаспоряжение.Организация = ОрганизацииКИ.Ссылка
	|			И (ОрганизацииКИ.Вид = ЗНАЧЕНИЕ(Справочник.ВидыКонтактнойИнформации.ЮрАдресОрганизации))
	|ГДЕ
	|	ДокументРаспоряжение.Ссылка В(&МассивРаспоряжений)
	|
	...
	//begin fix Клещ А.Н. 10.10.2019  
	ЕстьОперация = Ложь;
	Если ЗначениеЗаполнено(ЗаданиеНаПеревозку) Тогда 
		РеквизитыДокумента = ЗаданиеНаПеревозку.Метаданные().Реквизиты;
		ЕстьОперация = не РеквизитыДокумента.Найти("Операция") = Неопределено;
	КонецЕсли;
	//end fix Клещ А.Н. 10.10.2019

	Если ЕстьОперация и ЗаданиеНаПеревозку.Операция = Перечисления.ВидыДоставки.НаСклад Тогда        // begin fix Suetin 09.10.2019 18:44:53
		РеквизитыТранспортнойНакладной.АдресДоставки				= Неопределено;	
		РеквизитыТранспортнойНакладной.АдресДоставкиЗначенияПолей 	= Неопределено;
	КонецЕсли;	                                                                      // end fix Suetin 09.10.2019 18:45:52
...
&Вместо("СравнитьРеквизитыТОРГ12ПослеЗаписи")
Процедура ВИЛС_СравнитьРеквизитыТОРГ12ПослеЗаписи(Форма)
	...
	"ВЫБРАТЬ
	|	ТранспортнаяНакладнаяДокументыОснования.Ссылка КАК ТранспортнаяНакладная,
	//|	КОЛИЧЕСТВО(ТранспортнаяНакладнаяДокументыОснования.ДокументОснование) КАК КоличествоДокументовОснований        // begin fix Suetin 26.09.2019 17:18:03
	|	КОЛИЧЕСТВО(ТранспортнаяНакладнаяДокументыОснования.ВИЛС_ДокументОснование) КАК КоличествоДокументовОснований   // end fix Suetin 26.09.2019 17:18:07
	|ИЗ
	|	Документ.ТранспортнаяНакладная.ДокументыОснования КАК ТранспортнаяНакладнаяДокументыОснования
	|ГДЕ                                                                                                               
	//|	ТранспортнаяНакладнаяДокументыОснования.ДокументОснование = &ДокументОснование                                 // begin fix Suetin 26.09.2019 17:18:12
	|	ТранспортнаяНакладнаяДокументыОснования.ВИЛС_ДокументОснование = &ДокументОснование                            // end fix Suetin 26.09.2019 17:18:16
	|	И НЕ ТранспортнаяНакладнаяДокументыОснования.Ссылка.ПометкаУдаления
	|	И ТранспортнаяНакладнаяДокументыОснования.Ссылка.Проведен
	|
	|СГРУППИРОВАТЬ ПО
...
&Вместо("АктуализироватьТранспортныеНакладные")
Процедура ВИЛС_АктуализироватьТранспортныеНакладные(Основание, Проведен, ПометкаУдаления)
	...
	|	Документ.ТранспортнаяНакладная.ДокументыОснования КАК ТранспортнаяНакладнаяДокументыОснования
	|ГДЕ
	//|	ТранспортнаяНакладнаяДокументыОснования.ДокументОснование = &ДокументОснование                   // begin fix Suetin 26.09.2019 17:20:02
	|	ТранспортнаяНакладнаяДокументыОснования.ВИЛС_ДокументОснование = &ДокументОснование              // end fix Suetin 26.09.2019 17:20:06
	|	И НЕ ТранспортнаяНакладнаяДокументыОснования.Ссылка.ПометкаУдаления";
...
&Вместо("АктуализироватьТранспортныеНакладныеИзЗаданияНаПеревозку")
Процедура ВИЛС_АктуализироватьТранспортныеНакладныеИзЗаданияНаПеревозку(Распоряжения, ЗаданиеНаПеревозку, НомерСтрокиМаршрута)
	...
	|	НакладныеПоЗаданиямНаПеревозку КАК НакладныеПоЗаданиямНаПеревозку
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.ТранспортнаяНакладная.ДокументыОснования КАК ТранспортнаяНакладнаяДокументыОснования
	//|		ПО НакладныеПоЗаданиямНаПеревозку.Накладная = ТранспортнаяНакладнаяДокументыОснования.ДокументОснование           // begin fix Suetin 26.09.2019 17:21:08
	|		ПО НакладныеПоЗаданиямНаПеревозку.Накладная = ТранспортнаяНакладнаяДокументыОснования.ВИЛС_ДокументОснование      // end fix Suetin 26.09.2019 17:21:16
...
&ИзменениеИКонтроль("ПолучитьТолькоДокументыОснованияСТоварами")
Функция ВИЛС_ПолучитьТолькоДокументыОснованияСТоварами1(МассивВсехРаспоряжений, Отказ)
...
#КонецВставки
	...
	РеализацияТоваровУслугЛокализация.ПоместитьВременнуюТаблицуТоваров(МенеджерВременныхТаблиц);
#Вставка
	РеализацияУслугПрочихАктивовЛокализация.ПоместитьВременнуюТаблицуТоваров(МенеджерВременныхТаблиц);
#КонецВставки
	ВозвратТоваровПоставщикуЛокализация.ПоместитьВременнуюТаблицуТоваров(МенеджерВременныхТаблиц);
	ПеремещениеТоваровЛокализация.ПоместитьВременнуюТаблицуТоваров(МенеджерВременныхТаблиц);
	КорректировкаРеализацииЛокализация.ПоместитьВременнуюТаблицуТоваров(МенеджерВременныхТаблиц);
...
//Функция ВИЛС_1(МассивОбъектов, ВыделенныеСтроки = Неопределено) Экспорт
//	перем СозданныеТранспортныеНакладные;
////	 &ИзменениеИКонтроль("СоздатьТранспортныеНакладныеДляЗаданийНаПеревозку")
//	//Запрос = Новый Запрос;
//	//Запрос.Текст = Документы.ЗаданиеНаПеревозку.ТекстЗапросаПолученияСпискаНакладныхИзЗаданийНаПеревозку() + 
//	//"ВЫБРАТЬ РАЗЛИЧНЫЕ
//	//|	НакладныеПоЗаданиямНаПеревозку.ЗаданиеНаПеревозку КАК Ссылка,
