...
Процедура ВИЛС_ПриСозданииНаСервереПосле(Отказ, СтандартнаяОбработка)
	...
	//МассивТипов.Добавить(Тип("ДокументСсылка.ПередачаДавальцу"));
	//МассивТипов.Добавить(Тип("ДокументСсылка.ВозвратТоваровПоставщику"));
	//МассивТипов.Добавить(Тип("ДокументСсылка.ОтгрузкаТоваровСХранения"));
	//МассивТипов.Добавить(Тип("ДокументСсылка.ПеремещениеТоваров"));
	//МассивТипов.Добавить(Тип("ДокументСсылка.ВозвратСырьяДавальцу"));
	...
	//МассивТипов.Добавить(Тип("ДокументСсылка.ПередачаСырьяПереработчику"));
	...
	//РеквизитФормы = Новый РеквизитФормы("ВИЛС_ДокументОснование", ДопустимыеТипы, "Объект.ДокументыОснования", "Документ основание (ВИЛС)", Истина);
	//МассивРеквизитов.Добавить(РеквизитФормы);
	//ИзменитьРеквизиты(МассивРеквизитов);
	//Объект.ДокументыОснования.ДокументОснование.ПроверкаЗаполнения=
