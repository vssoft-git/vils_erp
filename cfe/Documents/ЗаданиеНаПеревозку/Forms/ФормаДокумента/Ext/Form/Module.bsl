...
Процедура ВИЛС_ПереопределитьРеквизиты()
	...
	//////ТФЗ = РеквизитФормыВЗначение("Объект.Маршрут");
	//////ТЗ = ТФЗ.Выгрузить();
	//////Колонка = ТЗ.Колонки.Добавить("ВИЛС_КонтактныеЛица", ДопустимыеТипы);
	//////РеквизитФормы = Новый РеквизитФормы(Колонка.Имя, Колонка.ТипЗначения, "Объект.Маршрут", Колонка.Заголовок);
	//////МассивКолонок.Добавить(РеквизитФормы);
	//////ТФЗ.Загрузить(ТЗ);
	////////ЗначениеВРеквизитФормы(ТФЗ, "Маршрут");
