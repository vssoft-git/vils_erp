...
Функция ВИЛС_ТекстЗапросаДанныхШапкиДляПечатиСчетаФактуры(ПараметрыПечати)
	...
	//|   ВЫБОР КОГДА ДанныеОснований.Ссылка ССЫЛКА Документ.АктВыполненныхРабот ТОГДА ДанныеОснований.Договор ИНАЧЕ НЕОПРЕДЕЛЕНО КОНЕЦ КАК Договор,    // fix Suetin 05.02.2019 2:40:45
