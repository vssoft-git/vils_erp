...
Функция ПечатьРеестрДебиторскойЗадолженностиПриложение_7_1_180510(МассивОбъектов, ОбъектыПечати)
	...
	Для каждого Ссылка Из МассивОбъектов Цикл
		...
		Для каждого СтрокаТЗ из СтрокиТЗ цикл
			...
			СведенияОбКонтрагенте = ФормированиеПечатныхФорм.СведенияОЮрФизЛице(СтрокаТЗ.Контрагент, ДатаДокументаИнветаризации);
			...
			ОбластьСтрока.Параметры.НомерДоговора = ?(ЗначениеЗаполнено(СтрокаТЗ.ДоговорКонтрагента),?(ЗначениеЗаполнено(СтрокаТЗ.ДоговорКонтрагента.Номер), СтрокаТЗ.ДоговорКонтрагента.Номер, СтрокаТЗ.ДоговорКонтрагента.Наименование), "б.н.");
			ОбластьСтрока.Параметры.ДатаДоговора = ?(ЗначениеЗаполнено(СтрокаТЗ.ДоговорКонтрагента),СтрокаТЗ.ДоговорКонтрагента.Дата, Дата(1,1,1,0,0,0));
