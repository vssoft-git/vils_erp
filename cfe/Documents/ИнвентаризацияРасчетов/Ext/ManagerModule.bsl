...
Функция ПечатьРеестрДебиторскойЗадолженностиПриложение_7_1(Знач МассивОбъектов, Знач ОбъектыПечати)
	...
	Возврат(ПечатьРеестрЗадолженностиПриложение_7_1(МассивОбъектов, ОбъектыПечати, ТабДокумент, ДтКт, Макет, ТекстЗапроса));
КонецФункции
...
Функция ПечатьРеестрЗадолженностиПриложение_7_1(Знач МассивОбъектов, Знач ОбъектыПечати, ТабДокумент, Знач ДтКт = "Дт", Знач Макет, Знач ТекстЗапроса)
