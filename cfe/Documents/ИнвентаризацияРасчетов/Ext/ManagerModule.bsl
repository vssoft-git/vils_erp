...
Функция ПечатьРеестрПросроченнойДебиторскойЗадолженностиПриложение_7_2(МассивОбъектов, ОбъектыПечати)
	...
	Возврат(ПечатьРеестрПросроченнойЗадолженностиПриложение_7_2(МассивОбъектов, ОбъектыПечати, ТабДокумент, "Дт", Макет, ТекстЗапроса, ТекстЗаголовка));
КонецФункции
...
Функция ПечатьРеестрПросроченнойКредиторскойЗадолженностиПриложение_7_2(МассивОбъектов, ОбъектыПечати)
	...
	Возврат(ПечатьРеестрПросроченнойЗадолженностиПриложение_7_2(МассивОбъектов, ОбъектыПечати, ТабДокумент, "Кт", Макет, ТекстЗапроса, ТекстЗаголовка));
КонецФункции

Функция ПечатьРеестрПросроченнойЗадолженностиПриложение_7_2(Знач МассивОбъектов, Знач ОбъектыПечати, ТабДокумент, Знач ДтКт = "Дт", Знач Макет, Знач ТекстЗапроса, Знач ТекстЗаголовка)
