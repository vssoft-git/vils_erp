...
&НаКлиенте
Процедура ПересчитатьСтроку(РедактируемаяСтрока)
	...
	Сумма = РедактируемаяСтрока.Цена * ?(не РедактируемаяСтрока.КоличествоУпаковок = 0,РедактируемаяСтрока.Количество,РедактируемаяСтрока.КоличествоУпаковок);
