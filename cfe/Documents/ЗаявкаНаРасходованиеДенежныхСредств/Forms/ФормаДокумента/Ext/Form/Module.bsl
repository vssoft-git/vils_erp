...
&НаКлиенте
Процедура ВИЛС_КурсНаДатуОтгрузки_ПриИзменении(Элемент)
	Объект.ВИЛС_КурсНаДатуОтгрузки = (ЭтотОбъект.ВИЛС_КурсНаДатуОтгрузки = 1);
	Элементы.ВИЛС_КурсНаДату.Видимость = Объект.ВИЛС_КурсНаДатуОтгрузки;
КонецПроцедуры
