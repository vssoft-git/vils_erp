...
Функция ВИЛС_СформироватьПечатнуюФормуТ13(МассивОбъектов, ОбъектыПечати)
	...
	Пока ВыборкаДанныхОВремени.СледующийПоЗначениюПоля("Ссылка") Цикл
		...
		Пока ВыборкаДанныхОВремени.СледующийПоЗначениюПоля("Сотрудник") Цикл
			...
			ЯвкиПерваяПоловина = ?(ОтработаноЧасовЗаПервуюПоловинуМесяца,"Я"+ОтработаноЧасовЗаПервуюПоловинуМесяца,"");
			ЯвкиВтораяПоловина = ?(ОтработаноЧасовЗаВторуюПоловинуМесяца,"Я"+ОтработаноЧасовЗаВторуюПоловинуМесяца,"");
			ЯвкиЗаМесяц        = ?(ОтработаноЧасовЗаПервуюПоловинуМесяца+ОтработаноЧасовЗаВторуюПоловинуМесяца,"Я"+(ОтработаноЧасовЗаПервуюПоловинуМесяца+ОтработаноЧасовЗаВторуюПоловинуМесяца),"");
			...
			ВечерниеЗамесяц        = ?(ОтработаноВечернихЧасовЗаВторуюПоловинуМесяца+ОтработаноВечернихЧасовЗаВторуюПоловинуМесяца,"/ВЧ"+(ОтработаноВечернихЧасовЗаВторуюПоловинуМесяца+ОтработаноВечернихЧасовЗаВторуюПоловинуМесяца),"");
			...
			ОбластьДанныеОВремениПараметры.ЧасыПерваяПоловина = ""+ЯвкиПерваяПоловина+""+ВечерниеПерваяПоловина+""+НочныеПерваяПоловина;//Клещ А.Н. ОтработаноЧасовЗаПервуюПоловинуМесяца;
			ОбластьДанныеОВремениПараметры.ДниВтораяПоловина = ОтработаноДнейЗаВторуюПоловинуМесяца;
			ОбластьДанныеОВремениПараметры.ЧасыВтораяПоловина = ""+ЯвкиВтораяПоловина+""+ВечерниеВтораяПоловина+""+НочныеВтораяПоловина;//Клещ А.Н.ОтработаноЧасовЗаВторуюПоловинуМесяца;
			ОбластьДанныеОВремениПараметры.ДниЗаМесяц = ОтработаноДнейЗаМесяц;
			ОбластьДанныеОВремениПараметры.ЧасыЗаМесяц = ""+ЯвкиЗаМесяц+""+ВечерниеЗамесяц+""+НочныеЗаМесяц;//Клещ А.Н. ОтработаноЧасовЗаМесяц;
