					...
					Пока ВыборкаДанныхОВремени.Следующий() Цикл
						...
						Если ВыборкаДанныхОВремени.РабочееВремя
							...
							Если День(ВыборкаДанныхОВремени.Дата) > 15 Тогда
								...
								//begin fix Клещ А.Н. 09.07.2019  
								Если ВыборкаДанныхОВремени.ОсновноеВремя.БуквенныйКод = "Н" или ВыборкаДанныхОВремени.БуквенныйКод = "НРВ" Тогда
							...
							Иначе
								...
								//begin fix Клещ А.Н. 09.07.2019  
								Если ВыборкаДанныхОВремени.ОсновноеВремя.БуквенныйКод = "Н" или ВыборкаДанныхОВремени.БуквенныйКод = "НРВ" Тогда
									Если ВыборкаДанныхОВремени.ОсновноеВремя.БуквенныйКод = "НРВ"  Тогда
										Сообщить(ВыборкаДанныхОВремени.ОсновноеВремя.БуквенныйКод);
									КонецЕсли;
