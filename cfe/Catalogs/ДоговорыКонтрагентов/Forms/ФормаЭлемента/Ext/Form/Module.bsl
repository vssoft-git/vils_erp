...
Процедура ВИЛС_ПриСозданииНаСервереПосле(Отказ, СтандартнаяОбработка)
	...
	Если ЗначениеЗаполнено(Объект.Партнер) Тогда 
		ДоставкаТоваров.ВИЛС_ЗаполнитьСписокВыбораАдресовКонтрагентаПартнера(Элементы, Объект.Партнер, "АдресДоставкиДляПоставщика");
	КонецЕсли;
	Если ЗначениеЗаполнено(Объект.Ссылка) Тогда
		ДоставкаТоваров.ВИЛС_ЗаполнитьСписокВыбораАдресовКонтрагентаПартнера(Элементы, Объект.Контрагент, "АдресДоставкиДляПоставщика", Ложь);
	КонецЕсли;
	ДоставкаТоваров.ВИЛС_СкопироватьСписокЗначений(Элементы.АдресДоставкиПеревозчика.СписокВыбора, Элементы["АдресДоставкиДляПоставщика"].СписокВыбора);
КонецПроцедуры
...
&НаСервере
&Перед("ЗаполнитьУстановитьРеквизитыДоставкиСервер")
Процедура ВИЛС_ЗаполнитьУстановитьРеквизитыДоставкиСервер(ИмяЭлементаФормы)
	Если Объект.ТипДоговора = Перечисления.ТипыДоговоров.СПоставщиком
		и Не Объект.ВариантПриемкиТоваров = Перечисления.ВариантыПриемкиТоваров.РазделенаПоЗаказамИНакладным Тогда
